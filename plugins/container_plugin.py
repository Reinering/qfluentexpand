...
class CardGroupWidgetPlugin(ContainerPlugin, QDesignerCustomWidgetInterface):
    """ Header card widget plugin """

    def createWidget(self, parent):
        return CardGroupWidget('', '', '', parent)
...
class GroupHeaderCardWidgetPlugin(ContainerPlugin, QDesignerCustomWidgetInterface):
    """ Header card widget plugin """

    def createWidget(self, parent):
        return GroupHeaderCardWidget(parent)

    def icon(self):
        return super().icon("CommandBar")

    def name(self):
        return "GroupHeaderCardWidget"
