...
class NavigationInterface(QWidget):
    ...
    showMenu = Property(bool, fset=lambda self, value: self.setMenuButtonVisible(value),
                        fget=lambda self: self.panel._isMenuButtonVisible)
    showReturn = Property(bool, fset=lambda self, value: self.setReturnButtonVisible(value),
                          fget=lambda self: self.panel._isReturnButtonVisible)
    collapsible = Property(bool, fset=lambda self, value: self.setCollapsible(value),
                           fget=lambda self: self.panel._isCollapsible)
